...
public class PermissionManager {
    ...
    public static void surePermission(final String text, final Activity active, final int coutner, final String[] list, final Runnable complete)
    {
        ...
        final AlertDialog.Builder normalDialog = new AlertDialog.Builder(active);
                        ...
                        PermissionManager.tryPermision(list, new Runnable() {
                            ...
                            public void run() {
                                ...
                                else
                                {
                                    if(coutner < 3)
                                    {
                                        surePermission(text, active, coutner + 1, list, complete);
                                    }
                                    else
                                    {
                                        active.finish();
